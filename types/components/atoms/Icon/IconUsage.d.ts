 ...
 */
export declare const IconUsageExamples: () => import("react/jsx-runtime").JSX.Element;
...
export declare const IconBestPractices: () => import("react/jsx-runtime").JSX.Element;
...
export declare const TokenizedIcon: ({ icon, size, color, clickable, onClick, disabled, className, }: {
    icon: any;
