...
export { SimpleTopNav } from "./components/atoms/SimpleTopNav/SimpleTopNav";
export type { SimpleTopNavProps, SimpleTopNavItem } from "./components/atoms/SimpleTopNav/SimpleTopNav";
