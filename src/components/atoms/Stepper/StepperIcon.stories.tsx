...
export const AllSizes: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="default" size="xs">
          1
        </StepperIcon>
        <StepperIcon status="active" size="xs">
          2
        </StepperIcon>
        <StepperIcon status="complete" size="xs">
          <Icon icon={Check} />
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Extra Small (xs)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="default" size="sm">
          1
        </StepperIcon>
        <StepperIcon status="active" size="sm">
          2
        </StepperIcon>
        <StepperIcon status="complete" size="sm">
          <Icon icon={Check} />
        </StepperIcon>
      ...
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="default" size="lg">
          1
        </StepperIcon>
        <StepperIcon status="active" size="lg">
          2
        </StepperIcon>
        <StepperIcon status="complete" size="lg">
          <Icon icon={Check} />
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Large (lg)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="default" size="xl">
          1
        </StepperIcon>
        <StepperIcon status="active" size="xl">
          2
        </StepperIcon>
        <StepperIcon status="complete" size="xl">
          <Icon icon={Check} />
        </StepperIcon>
...
export const AllRadius: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius="xs">
          1
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Radius: Extra Small (xs)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius="sm">
          2
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Radius: Small (sm)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius="md">
          3
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Radius: Medium (md)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius="lg">
          4
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Radius: Large (lg)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius="xl">
          5
        </StepperIcon>
        <span style={{ fontSize: "12px" }}>Radius: Extra Large (xl)</span>
      </div>
      <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
        <StepperIcon status="active" size="md" radius={0}>
          6
        </StepperIcon>
