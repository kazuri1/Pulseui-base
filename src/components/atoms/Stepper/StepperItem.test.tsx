...
describe("StepperItem", () => {
  ...
  it("renders without label when showLabel is false", () => {
    render(
      <StepperItem label="Test Label" showLabel={false}>
        1
      </StepperItem>
    );
  ...
  it("shows asterisk when showAsterisk is true", () => {
    render(
      <StepperItem label="Required Field" showAsterisk>
        1
      </StepperItem>
    );
  ...
  it("does not show asterisk when showAsterisk is false", () => {
    render(
      <StepperItem label="Optional Field" showAsterisk={false}>
        1
      </StepperItem>
    );
  ...
  it("applies correct size classes", () => {
    const { rerender } = render(
      <StepperItem size="xs" label="Test">
        1
      </StepperItem>
    );
    ...
    rerender(
      <StepperItem size="lg" label="Test">
        1
      </StepperItem>
    );
  ...
  it("passes status and radius to StepperIcon", () => {
    render(
      <StepperItem status="active" radius="lg" label="Test">
        1
      </StepperItem>
    );
  ...
  it("applies custom className", () => {
    render(
      <StepperItem label="Test" className="custom-class">
        1
      </StepperItem>
    );
  ...
  it("applies custom id", () => {
    render(
      <StepperItem label="Test" id="test-id">
        1
      </StepperItem>
    );
  ...
  it("applies custom style", () => {
    render(
      <StepperItem label="Test" style={{ backgroundColor: "red" }}>
        1
      </StepperItem>
    );
  ...
  it("combines label and asterisk correctly", () => {
    render(
      <StepperItem label="Required" showAsterisk>
        1
      </StepperItem>
    );
