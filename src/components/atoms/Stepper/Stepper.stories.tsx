...
export const LongLabels: Story = {
  args: {
    steps: [
      { id: '1', content: '1', label: 'Personal Information and Details', status: 'complete' },
      { id: '2', content: '2', label: 'Contact Information and Preferences', status: 'active' },
      { id: '3', content: '3', label: 'Payment Method and Billing Address', status: 'default' },
    ],
  },
};
