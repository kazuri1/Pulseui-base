      ...
      items: [
        {
          ...
          icon: Sync,
          onClick: () => console.log("Transfer data clicked"),
        },
        {
          ...
          submenu: [
            {
              title: "Social Media",
              items: [
                { label: "Share to Twitter", onClick: () => console.log("Share to Twitter") },
                { label: "Share to Facebook", onClick: () => console.log("Share to Facebook") },
              ],
            },
            {
              title: "Email",
              items: [
                { label: "Share via Gmail", onClick: () => console.log("Share via Gmail") },
                { label: "Share via Outlook", onClick: () => console.log("Share via Outlook") },
              ],
            },
          ],
        },
